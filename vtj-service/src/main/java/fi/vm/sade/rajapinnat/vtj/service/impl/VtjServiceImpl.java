...
public class VtjServiceImpl implements VtjService {
    ...
    private void logVTJMessage(Henkilo vtjHenkilo) {
        ...
        sb.append("\nHenkilotunnus: " + vtjHenkilo.getHenkilotunnus());
        ...
        if (vtjHenkilo.getEdunvalvonta() != null) {
            ...
            if (vtjHenkilo.getEdunvalvonta().getHenkiloEdunvalvoja() != null) {
                ...
                for (HenkiloEdunvalvoja ev: vtjHenkilo.getEdunvalvonta().getHenkiloEdunvalvoja()) {
                    ...
                    sb.append("\n----NykyinenSukunimi: " + ev.getNykyinenSukunimi());
                    sb.append("\n----NykyisetEtunimet: " + ev.getNykyisetEtunimet());
                }
            }
            ...
            if (vtjHenkilo.getEdunvalvontavaltuutus() != null) {
                ...
                for (Edunvalvontavaltuutus evv : vtjHenkilo.getEdunvalvontavaltuutus()) {
                    ...
                    for (HenkiloEdunvalvontavaltuutettu hevv : evv.getHenkiloEdunvalvontavaltuutettu()) {
                        ...
                        sb.append("\n--------NykyinenSukunimi: " + hevv.getNykyinenSukunimi());
                        sb.append("\n--------NykyisetEtunimet: " + hevv.getNykyisetEtunimet());
                    }
                }
            }
        }
        if (vtjHenkilo.getHuoltaja() != null) {
            ...
            for (Huoltaja h : vtjHenkilo.getHuoltaja()) {
                ...
                sb.append("\n----NykyinenSukunimi" + h.getNykyinenSukunimi());
                sb.append("\n----NykyisetEtunimet" + h.getNykyisetEtunimet());
                if (h.getVakinainenKotimainenOsoite() != null) {
                    sb.append("\n----VakinainenKotimainenOsoite::AsuminenAlkupvm" + h.getVakinainenKotimainenOsoite().getAsuminenAlkupvm());
                    sb.append("\n----VakinainenKotimainenOsoite::AsuminenLoppupvm" + h.getVakinainenKotimainenOsoite().getAsuminenLoppupvm());
                    sb.append("\n----VakinainenKotimainenOsoite::Huoneistonumero" + h.getVakinainenKotimainenOsoite().getHuoneistonumero());
                    sb.append("\n----VakinainenKotimainenOsoite::Jakokirjain" + h.getVakinainenKotimainenOsoite().getJakokirjain());
                    sb.append("\n----VakinainenKotimainenOsoite::Katunumero" + h.getVakinainenKotimainenOsoite().getKatunumero());
                    sb.append("\n----VakinainenKotimainenOsoite::KatuS" + h.getVakinainenKotimainenOsoite().getKatuS());
                    sb.append("\n----VakinainenKotimainenOsoite::Porraskirjain" + h.getVakinainenKotimainenOsoite().getPorraskirjain());
                    sb.append("\n----VakinainenKotimainenOsoite::Postinumero" + h.getVakinainenKotimainenOsoite().getPostinumero());
                    sb.append("\n----VakinainenKotimainenOsoite::PostitoimipaikkaS" + h.getVakinainenKotimainenOsoite().getPostitoimipaikkaS());
                }
                if (h.getVakinainenUlkomainenOsoite() != null) {
                    sb.append("\n----VakinainenUlkomainenOsoite::AsuminenAlkupvm" + h.getVakinainenUlkomainenOsoite().getAsuminenAlkupvm());
                    sb.append("\n----VakinainenUlkomainenOsoite::AsuminenLoppupvm" + h.getVakinainenUlkomainenOsoite().getAsuminenLoppupvm());
                    sb.append("\n----VakinainenUlkomainenOsoite::UlkomainenLahiosoite" + h.getVakinainenUlkomainenOsoite().getUlkomainenLahiosoite());
                    sb.append("\n----VakinainenUlkomainenOsoite::UlkomainenPaikkakunta" + h.getVakinainenUlkomainenOsoite().getUlkomainenPaikkakunta());
                    sb.append("\n----VakinainenUlkomainenOsoite::Valtiokoodi3" + h.getVakinainenUlkomainenOsoite().getValtiokoodi3());
                    sb.append("\n----VakinainenUlkomainenOsoite::ValtioS" + h.getVakinainenUlkomainenOsoite().getValtioS());
                    sb.append("\n----VakinainenUlkomainenOsoite::ValtioSelvakielinen" + h.getVakinainenUlkomainenOsoite().getValtioSelvakielinen());
                }
            }
        }
        sb.append("\nKansalaisuudet[]:");
